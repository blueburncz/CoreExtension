...
/// @func ce_quaternion_to_matrix(_q, _m)
/// @desc Writes quaternion rotation into the matrix.
/// @param {real[4]} _q The quaternion.
/// @param {real[16]} _m The target matrix.
function ce_quaternion_to_matrix(_q, _m)
{
	gml_pragma("forceinline");
	...
	_temp1 = _q1 * _q1;
	_temp2 = _q2 * _q2;
	_m[@ 0] = 1 - 2 * (_temp1 + _temp2);
	_m[@ 5] = 1 - 2 * (_temp0 + _temp2);
	_m[@ 10] = 1 - 2 * (_temp0 + _temp1);

	_temp0 = _q0 * _q1;
	_temp1 = _q3 * _q2;
	_m[@ 1] = 2 * (_temp0 + _temp1);
	_m[@ 4] = 2 * (_temp0 - _temp1);

	_temp0 = _q0 * _q2
	_temp1 = _q3 * _q1;
	_m[@ 2] = 2 * (_temp0 - _temp1);
	_m[@ 8] = 2 * (_temp0 + _temp1);

	_temp0 = _q1 * _q2;
	_temp1 = _q3 * _q0;
	_m[@ 6] = 2 * (_temp0 + _temp1);
	_m[@ 9] = 2 * (_temp0 - _temp1);
}