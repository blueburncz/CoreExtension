...
function CE_Hammersley2D(_i, _n)
{
	var b = (_n << 16) | (_n >> 16);
...
/// @func CE_PointInRectangle(_pointX, _pointY, _rectX, _rectY, _rectWidth, _rectHeight)
...
function CE_PointInRectangle(_pointX, _pointY, _rectX, _rectY, _rectWidth, _rectHeight)
{
...
/// @func CE_ScaleKeepAspectRatio(_targetW _targetH, _width, _height)
...
function CE_ScaleKeepAspectRatio(_targetW, _targetH, _width, _height)
{
