/// @func CE_DrawRectangle(_x, _y, _width, _height[, _color[, _alpha]])
...
function CE_DrawRectangle(_x, _y, _width, _height)
{
...
/// @func CE_DrawSpriteNineSlice(_sprite, _subimage, _x, _y, _width, _height, _tiled[, _color[, _alpha]])
...
function CE_DrawSpriteNineSlice(_sprite, _subimage, _x, _y, _width, _height, _tiled)
{
...
/// @func CE_DrawTextShadow(_x, _y, _string[, _color[, _shadow]])
...
function CE_DrawTextShadow(_x, _y, _string)
{
