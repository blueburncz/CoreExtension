/// @func CE_Quaternion([_x, _y, _z, _w])
/// @desc A quaternion.
...
/// is created.
function CE_Quaternion(_x, _y, _z, _w) constructor
{
	...
	static Clone = function () {
		gml_pragma("forceinline");
		return new CE_Quaternion(X, Y, Z, W);
	};
	...
	/// @param {CE_Quaternion} _dq The destination quaternion.
	/// @return {CE_Quaternion} Returns `self`.
	...
	/// @para {CE_Quaternion} _q The other quaternion.
	...
	static Exp = function () {
		...
		return new CE_Quaternion(0.0, 0.0, 0.0, exp(W));
	};
	...
	/// @param {CE_Vec3} _axis The axis of rotaiton.
	...
	/// identity.
	/// @param {CE_Vec3} _forward The vector facing forward.
	/// @param {CE_Vec3} _up The vector facing up.
	/// @return {CE_Quaternion} Returns `self`.
	...
	/// @return {CE_Vec3} The axis of rotation.
	...
	/// @param {CE_Quaternion} _q The other quaternion.
	...
	static Log = function () {
		...
		return new CE_Quaternion(0.0, 0.0, 0.0, _w);
	};
	...
	static Rotate = function (_v) {
		gml_pragma("forceinline");
		var _q = Normalize();
		var _V = new CE_Quaternion(_v.X, _v.Y, _v.Z, 0.0);
		var _rot = _q.Mul(_V).Mul(_q.Conjugate());
		return new CE_Vec3(_rot.X, _rot.Y, _rot.Z);
	};
