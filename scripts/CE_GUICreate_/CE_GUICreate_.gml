/// @func CE_GUICreateText(_text[, _props])
/// @desc Creates a new text widget.
/// @param {string} _text
/// @param {struct} [_props]
/// @return {CE_GUIWidget} The created widget.
function CE_GUICreateText(_text, _props={})
{
...
/// @func CE_GUICreateGrid(_cols, _rows[, _x[, _y[, _width[, _height]]]])
...
function CE_GUICreateGrid(_rows, _cols)
{
...
/// @return {CE_GUIContainer} The created widget.
function CE_GUICreateHBox(_x=0, _y=0)
{
	var _w = new CE_GUIContainer();
...
/// @func CE_GUICreateSprite(_sprite[, _index[, _x[, _y[, _color[, _alpha]]]]])
...
/// @return {CE_GUIWidget} The created widget.
function CE_GUICreateSprite(_sprite, _index=0, _x=0, _y=0, _color=c_white, _alpha=1)
{
...
/// @func CE_GUICreateVBox([_x[, _y]])
/// @desc Creates a new vertical box widget.
/// @param {real} [_x] The x position. Defaults to 0.
/// @param {real} [_y] The y position. Defaults to 0.
/// @return {CE_GUIContainer} The created widget.
function CE_GUICreateVBox(_x=0, _y=0)
{
	var _w = new CE_GUIContainer();
